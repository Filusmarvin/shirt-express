...
app.get('/movies/:movieId', function (request, response) {
  let movieId = request.params.movieId; //request.params gives you an object of movies and the '.movie' is child
  let index   = ParseInt(movieId);
  let movie   = movies[index];
  response.send(movie);   //this takes the information you wanted and puts it on the screen.
})
